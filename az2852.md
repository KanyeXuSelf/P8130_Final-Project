...
```
    ...
    ## wkly_study_hours10-May          3.5394     1.3429   2.636 0.008631 ** 
    ## ---
...
Call: lm(formula = math_score ~ gender + ethnic_group + parent_educ +
lunch_type + test_prep + parent_marital_status + nr_siblings +
wkly_study_hours, data = math_df)
...
```
    ...
    ##                                s1
    ## (Intercept)            75.6044327
    ## gender                  4.5221418
    ## ethnic_group            2.6805828
    ## parent_educ            -0.7662117
    ## lunch_type            -11.7472571
    ## test_prep              -4.8239735
    ## parent_marital_status  -1.0337427
    ## practice_sport          .        
    ## is_first_child          .        
    ## nr_siblings             0.5181278
    ## transport_means         .        
    ## wkly_study_hours        1.3657568
...
```
    ...
    ## gendermale:ethnic_groupgroup C                                                           gendermale:ethnic_groupgroup C
    ...
    ## parent_educassociate's degree:parent_marital_statusdivorced parent_educassociate's degree:parent_marital_statusdivorced
    ## parent_educhigh school:parent_marital_statusdivorced               parent_educhigh school:parent_marital_statusdivorced
    ## test_prepnone:parent_marital_statusdivorced                                 test_prepnone:parent_marital_statusdivorced
    ## parent_marital_statuswidowed:wkly_study_hours10-May                 parent_marital_statuswidowed:wkly_study_hours10-May
    ##                                                             Coefficient
    ## (Intercept)                                                   85.313774
    ## test_prepnone                                                -16.919969
    ## gendermale:ethnic_groupgroup C                                11.333618
    ## gendermale:parent_educmaster's degree                         16.838302
    ## ethnic_groupgroup E:test_prepnone                             13.769140
    ## parent_educassociate's degree:parent_marital_statusdivorced  -21.250715
    ## parent_educhigh school:parent_marital_statusdivorced         -19.726259
    ## test_prepnone:parent_marital_statusdivorced                   -8.028161
    ## parent_marital_statuswidowed:wkly_study_hours10-May           84.642589
    ##                                                                  P_Value
    ## (Intercept)                                                 1.183835e-08
    ## test_prepnone                                               2.558638e-02
    ## gendermale:ethnic_groupgroup C                              4.746919e-02
    ## gendermale:parent_educmaster's degree                       1.323744e-02
    ## ethnic_groupgroup E:test_prepnone                           2.810388e-02
    ## parent_educassociate's degree:parent_marital_statusdivorced 7.239437e-03
    ## parent_educhigh school:parent_marital_statusdivorced        9.535021e-03
    ## test_prepnone:parent_marital_statusdivorced                 4.140074e-02
    ## parent_marital_statuswidowed:wkly_study_hours10-May         3.297873e-02
...
```
    ...
    ## lm(formula = math_score ~ gender + ethnic_group + parent_educ + 
    ##     lunch_type + test_prep + parent_marital_status + nr_siblings + 
    ##     wkly_study_hours + ethnic_group:test_prep + parent_educ:parent_marital_status + 
    ##     test_prep:parent_marital_status + parent_marital_status:wkly_study_hours, 
    ##     data = math_df)
    ## 
    ## Residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -48.532  -8.783   0.433   9.925  29.698 
    ## 
    ## Coefficients:
    ##                                                             Estimate Std. Error
    ## (Intercept)                                                  73.8421     4.3091
    ## gendermale                                                    5.1217     1.1500
    ## ethnic_groupgroup B                                          -3.6673     3.8897
    ## ethnic_groupgroup C                                          -2.8857     3.7349
    ## ethnic_groupgroup D                                          -1.0713     3.8890
    ## ethnic_groupgroup E                                           7.2807     4.0154
    ## parent_educassociate's degree                                -0.2814     2.5448
    ## parent_educhigh school                                       -5.8957     2.5737
    ## parent_educmaster's degree                                    1.7840     3.6807
    ## parent_educsome college                                      -2.3108     2.5677
    ## parent_educsome high school                                  -5.8557     2.6461
    ## lunch_typefree/reduced                                      -12.5322     1.1869
    ## test_prepnone                                                -8.7536     4.1846
    ## parent_marital_statusdivorced                                17.7123     7.1382
    ## parent_marital_statussingle                                  -8.1947     4.7228
    ## parent_marital_statuswidowed                                  2.3811    19.9182
    ## nr_siblings                                                   0.7191     0.3838
    ## wkly_study_hours> 10                                          1.9373     2.2534
    ## wkly_study_hours10-May                                        2.0320     1.7325
    ## ethnic_groupgroup B:test_prepnone                             5.8803     4.7991
    ## ethnic_groupgroup C:test_prepnone                             4.7937     4.5791
    ## ethnic_groupgroup D:test_prepnone                             7.1948     4.7168
    ## ethnic_groupgroup E:test_prepnone                             7.0465     5.0276
    ## parent_educassociate's degree:parent_marital_statusdivorced -21.1695     6.6301
    ## parent_educhigh school:parent_marital_statusdivorced        -17.7657     6.4193
    ## parent_educmaster's degree:parent_marital_statusdivorced    -18.9635     7.9627
    ## parent_educsome college:parent_marital_statusdivorced       -11.2865     6.5418
    ## parent_educsome high school:parent_marital_statusdivorced   -11.7854     6.5269
    ## parent_educassociate's degree:parent_marital_statussingle     3.7031     5.0146
    ## parent_educhigh school:parent_marital_statussingle            6.5429     5.2503
    ## parent_educmaster's degree:parent_marital_statussingle        3.0095     6.5262
    ## parent_educsome college:parent_marital_statussingle          -0.5537     5.2429
    ## parent_educsome high school:parent_marital_statussingle       0.8555     5.1187
    ## parent_educassociate's degree:parent_marital_statuswidowed    0.8602    19.8140
    ## parent_educhigh school:parent_marital_statuswidowed         -22.3711    10.9097
    ## parent_educmaster's degree:parent_marital_statuswidowed     -16.8910    18.9725
    ## parent_educsome college:parent_marital_statuswidowed          3.4001    12.8238
    ## parent_educsome high school:parent_marital_statuswidowed      8.2357    19.5897
    ## test_prepnone:parent_marital_statusdivorced                  -8.2831     3.4893
    ## test_prepnone:parent_marital_statussingle                    -3.1010     2.8569
    ## test_prepnone:parent_marital_statuswidowed                   -2.4924    10.6227
    ## parent_marital_statusdivorced:wkly_study_hours> 10           -8.5909     5.1694
    ## parent_marital_statussingle:wkly_study_hours> 10              7.2686     4.1399
    ## parent_marital_statuswidowed:wkly_study_hours> 10            -5.1063    16.0115
    ## parent_marital_statusdivorced:wkly_study_hours10-May         -2.7224     3.9171
    ## parent_marital_statussingle:wkly_study_hours10-May            5.8576     3.1680
    ## parent_marital_statuswidowed:wkly_study_hours10-May          10.7658    14.1915
    ##                                                             t value Pr(>|t|)
    ## (Intercept)                                                  17.136  < 2e-16
    ## gendermale                                                    4.454 1.03e-05
    ## ethnic_groupgroup B                                          -0.943  0.34619
    ## ethnic_groupgroup C                                          -0.773  0.44008
    ## ethnic_groupgroup D                                          -0.275  0.78305
    ## ethnic_groupgroup E                                           1.813  0.07036
    ## parent_educassociate's degree                                -0.111  0.91198
    ## parent_educhigh school                                       -2.291  0.02236
    ## parent_educmaster's degree                                    0.485  0.62809
    ## parent_educsome college                                      -0.900  0.36854
    ## parent_educsome high school                                  -2.213  0.02732
    ## lunch_typefree/reduced                                      -10.559  < 2e-16
    ## test_prepnone                                                -2.092  0.03692
    ## parent_marital_statusdivorced                                 2.481  0.01339
    ## parent_marital_statussingle                                  -1.735  0.08329
    ## parent_marital_statuswidowed                                  0.120  0.90489
    ## nr_siblings                                                   1.874  0.06152
    ## wkly_study_hours> 10                                          0.860  0.39031
    ## wkly_study_hours10-May                                        1.173  0.24136
    ## ethnic_groupgroup B:test_prepnone                             1.225  0.22100
    ## ethnic_groupgroup C:test_prepnone                             1.047  0.29563
    ## ethnic_groupgroup D:test_prepnone                             1.525  0.12775
    ## ethnic_groupgroup E:test_prepnone                             1.402  0.16162
    ## parent_educassociate's degree:parent_marital_statusdivorced  -3.193  0.00149
    ## parent_educhigh school:parent_marital_statusdivorced         -2.768  0.00584
    ## parent_educmaster's degree:parent_marital_statusdivorced     -2.382  0.01759
    ## parent_educsome college:parent_marital_statusdivorced        -1.725  0.08505
    ## parent_educsome high school:parent_marital_statusdivorced    -1.806  0.07153
    ## parent_educassociate's degree:parent_marital_statussingle     0.738  0.46055
    ## parent_educhigh school:parent_marital_statussingle            1.246  0.21323
    ## parent_educmaster's degree:parent_marital_statussingle        0.461  0.64489
    ## parent_educsome college:parent_marital_statussingle          -0.106  0.91594
    ## parent_educsome high school:parent_marital_statussingle       0.167  0.86733
    ## parent_educassociate's degree:parent_marital_statuswidowed    0.043  0.96539
    ## parent_educhigh school:parent_marital_statuswidowed          -2.051  0.04079
    ## parent_educmaster's degree:parent_marital_statuswidowed      -0.890  0.37371
    ## parent_educsome college:parent_marital_statuswidowed          0.265  0.79100
    ## parent_educsome high school:parent_marital_statuswidowed      0.420  0.67435
    ## test_prepnone:parent_marital_statusdivorced                  -2.374  0.01795
    ## test_prepnone:parent_marital_statussingle                    -1.085  0.27821
    ## test_prepnone:parent_marital_statuswidowed                   -0.235  0.81459
    ## parent_marital_statusdivorced:wkly_study_hours> 10           -1.662  0.09712
    ## parent_marital_statussingle:wkly_study_hours> 10              1.756  0.07970
    ## parent_marital_statuswidowed:wkly_study_hours> 10            -0.319  0.74991
    ## parent_marital_statusdivorced:wkly_study_hours10-May         -0.695  0.48735
    ## parent_marital_statussingle:wkly_study_hours10-May            1.849  0.06500
    ## parent_marital_statuswidowed:wkly_study_hours10-May           0.759  0.44842
    ##                                                                
    ## (Intercept)                                                 ***
    ## gendermale                                                  ***
    ## ethnic_groupgroup B                                            
    ...
    ## wkly_study_hours> 10                                           
    ## wkly_study_hours10-May                                         
    ## ethnic_groupgroup B:test_prepnone                              
    ## ethnic_groupgroup C:test_prepnone                              
    ## ethnic_groupgroup D:test_prepnone                              
    ## ethnic_groupgroup E:test_prepnone                              
    ...
    ## parent_marital_statusdivorced:wkly_study_hours> 10          .  
    ## parent_marital_statussingle:wkly_study_hours> 10            .  
    ## parent_marital_statuswidowed:wkly_study_hours> 10              
    ## parent_marital_statusdivorced:wkly_study_hours10-May           
    ## parent_marital_statussingle:wkly_study_hours10-May          .  
    ## parent_marital_statuswidowed:wkly_study_hours10-May            
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 13.3 on 540 degrees of freedom
    ## Multiple R-squared:  0.3718, Adjusted R-squared:  0.3183 
    ## F-statistic: 6.948 on 46 and 540 DF,  p-value: < 2.2e-16
