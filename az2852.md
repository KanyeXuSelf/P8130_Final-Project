...
```
    ...
    ##                                s1
    ## (Intercept)            75.5053664
    ## gender                  4.5686060
    ## ethnic_group            2.7023388
    ## parent_educ            -0.7799022
    ## lunch_type            -11.7917898
    ## test_prep              -4.8690377
    ## parent_marital_status  -1.0612522
    ## practice_sport          .        
    ## is_first_child          0.0518480
    ## nr_siblings             0.5369834
    ## transport_means         .        
    ## wkly_study_hours        1.3939948
...
```
    ...
    ## lm(formula = math_score ~ gender + ethnic_group + parent_educ + 
    ##     lunch_type + test_prep + parent_marital_status + nr_siblings + 
    ##     wkly_study_hours + reading_score + writing_score, data = score_df)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -18.0808  -3.9303   0.1288   3.5812  14.3019 
    ## 
    ## Coefficients:
    ##                                Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)                   -11.50161    1.95922  -5.871 7.41e-09 ***
    ## gendermale                     13.80577    0.49256  28.029  < 2e-16 ***
    ## ethnic_groupgroup B             1.15239    0.92572   1.245  0.21370    
    ## ethnic_groupgroup C             0.01508    0.88558   0.017  0.98642    
    ## ethnic_groupgroup D            -0.73464    0.90538  -0.811  0.41747    
    ## ethnic_groupgroup E             5.34606    0.98231   5.442 7.84e-08 ***
    ## parent_educassociate's degree   1.15343    0.81145   1.421  0.15573    
    ## parent_educhigh school          2.03936    0.84174   2.423  0.01571 *  
    ## parent_educmaster's degree     -2.07646    1.08812  -1.908  0.05686 .  
    ## parent_educsome college         1.42747    0.82612   1.728  0.08455 .  
    ## parent_educsome high school     2.01161    0.85238   2.360  0.01861 *  
    ## lunch_typefree/reduced         -3.34913    0.50230  -6.668 6.19e-11 ***
    ## test_prepnone                   3.19898    0.52070   6.144 1.52e-09 ***
    ## parent_marital_statusdivorced  -0.33594    0.65041  -0.517  0.60570    
    ## parent_marital_statussingle    -0.19627    0.55479  -0.354  0.72364    
    ## parent_marital_statuswidowed    0.96882    1.44308   0.671  0.50227    
    ## nr_siblings                     0.23820    0.15390   1.548  0.12223    
    ## wkly_study_hours> 10            1.86148    0.70201   2.652  0.00823 ** 
    ## wkly_study_hours5 to 10         0.82040    0.53956   1.520  0.12894    
    ## reading_score                   0.21631    0.05553   3.895  0.00011 ***
    ## writing_score                   0.76240    0.05801  13.142  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 5.413 on 566 degrees of freedom
    ## Multiple R-squared:  0.891,  Adjusted R-squared:  0.8871 
    ## F-statistic: 231.3 on 20 and 566 DF,  p-value: < 2.2e-16
